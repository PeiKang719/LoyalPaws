...
function showPet($pk, $sid) {
    ...
    if ($result->num_rows > 0) {
        ...
        foreach ($rows as $row) {
            ...
            echo '<a href="Seller_Pets-Profile.php?id=' . $row['petID'] . '" target="_self"><span class="material-symbols-outlined" id="card-button">open_in_new</span></a>';
            echo '<a href="Seller_Pets-Edit-Modal.php?petID=' . $row['petID'] . '" target="_self"><span class="material-symbols-outlined" id="card-button-edit">edit</span>';
