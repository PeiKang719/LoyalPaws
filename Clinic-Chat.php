...
<body>
  ...
  <div class="vet-message-container">
    <div class="vet-message-menu">
      <?php
      $sql = "SELECT DISTINCT a.firstName,a.lastName,a.adopterID,a.image FROM message m,adopter a WHERE m.adopterID=a.adopterID AND vetID= $vetID ORDER BY (SELECT MAX(messageID) FROM message WHERE adopterID = a.adopterID) DESC, a.adopterID ASC;";
...
$(document).ready(function() {
    ...
    if (isRadioChecked) {
      ...
      $.ajax({
        url: 'Clinic-Chat-Get-Message.php',
        type: 'GET',
