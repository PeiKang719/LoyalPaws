    ...
    if ($result->num_rows > 0) {
        ...
        if (file_exists('vet_images/' . $row['image'])) {
          ...
          if( $gender% 2 == 0){
            ...
            echo '<a href="Clinic-Vet-Profile.php?id=' . $row['vetID'] . '" target="_self"><span class="material-symbols-outlined" id="card-button">open_in_new</span></a>';
...
<?php
   ...
   <a style='color:#008ae6;text-decoration: underline;' href='../Admin/SideBar_Clinic-Downloadpdf.php?file=" . $apc . "'>" . $apc . "</a>
   <br><br><br>
   <br>
