...
if($row['cover']!=''){
    ...
    // Check if the image file exists before displaying it
    if (file_exists('../Seller/s_covers/seller/' . $row['cover'])) {
        $imageSrc3 = '../Seller/s_covers/seller/' .$row['cover'];
    }
    }
    else{
    ...
    if ($result->num_rows > 0) {
        ...
        foreach ($rows as $row) {
            ...
            if (file_exists('../Seller/pet_images/' . $row['pet_image'])) {
                $imageSrc = '../Seller/pet_images/' . $row['pet_image'];
            }
...
elseif (file_exists('../Seller/pet_shop_images/' . $row['shop_image'])) {
    $imageSrc = '../Seller/pet_shop_images/' . $row['shop_image'];
}
...
if($row['cover']!=''){
    ...
    $imageSrc3 = "data:image/jpg;base64," . $imageData2;
    // Check if the image file exists before displaying it
    if (file_exists('../Seller/s_covers/pet_shop/' . $row['cover'])) {
        $imageSrc3 = '../Seller/s_covers/pet_shop/' . $row['cover'];
    }
    }
    else{
        $imageSrc3='../media/clinic_cover.jpg';
