...
if(!isset($_POST['opentime']) ){
  ...
  if (isset($_FILES['img'])) {
    $target_dir = "../Seller/pet_shop_images/";
...
<?php
  ...
  $closetime3 = implode(',', $closetime3);
    ...
    if (isset($_FILES['img'])) {
    $target_dir = "../Seller/seller_images/";
    $unique_name = time() . '_' . $img;
    $target_path = $target_dir . $unique_name;
...
<?php
  ...
  echo '<script type="text/javascript">';
    ...
    if (isset($_FILES['img'])) {
    $target_dir = "../User/adopter_images/";
    $unique_name = time() . '_' . $img;
    $target_path = $target_dir . $unique_name;
...
// Check if the image file was uploaded without errors
if(isset($_FILES['img'])){
     $target_dir = "../Clinic/clinic_images/";
      $unique_name = time() . '_' . $img;
        $target_path = $target_dir . $unique_name;
