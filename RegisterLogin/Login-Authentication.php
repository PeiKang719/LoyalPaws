...
$password = $_POST["password1"];
 ...
 if ($result->num_rows == 1) { // check if the query returned a single row
  ...
  echo 'window.location.href = "../User/UserHomePage.php";';
  echo '</script>';
}
elseif($result2->num_rows == 1) {
  ...
  echo '<script type="text/javascript">';
  echo 'alert("Login successful!");';
  echo 'window.location.href = "../Seller/Seller_HomePage.php";';
  echo '</script>';
}
...
elseif($result4->num_rows == 1) {
  ...
  echo '<script type="text/javascript">';
  echo 'alert("Login successful!");';
  echo 'window.location.href = "../Clinic/Clinic-Dashboard.php";';
  echo '</script>';
  }else{
    echo '<script type="text/javascript">';
    echo 'alert("Login successful!");';
    echo 'window.location.href = "../Clinic/Clinic-Vet-Dashboard.php";';
    echo '</script>';
  }
}
elseif($result5->num_rows == 1) {
  ...
  echo '<script type="text/javascript">';
  echo 'alert("Login successful!");';
  echo 'window.location.href = "../Admin/AdminHomePage.php";';
  echo '</script>';
}
