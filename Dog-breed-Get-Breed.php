...
$sql = "SELECT * FROM breed WHERE type='Dog' and size=$size[0] and name LIKE '%$searchQuery%' ORDER BY name";
...
$sql = "SELECT * FROM breed WHERE type='Dog' and size=$size[0] ORDER BY name";
$result = $conn->query($sql);
...
$sql = "SELECT * FROM breed WHERE type='Dog' and name LIKE '%$searchQuery%' ORDER BY name";
$result = $conn->query($sql);
...
$sql = "SELECT * FROM breed WHERE type='Dog' and size='abc' ORDER BY name";
$result = $conn->query($sql);
