...
/*icon active color*/
  ...
  <body>
    ...
    <nav>
      ...
      <label class="logo"><a href="AdminHomePage.php"><img src="media/lp.png" width="250" height="70" style="margin-top: -30px;margin-bottom: -33px;"></a></label>
      <ul>
  ...
  <hr >
    ...
    <div class="dropdown-container">
      ...
      <a href="SideBar-Report.php" class="sidebar-item"><span class="material-symbols-outlined" id="sidebar-icon">bar_chart</span>&nbsp;Report</a>
