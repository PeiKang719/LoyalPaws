...
if (file_exists('../Clinic/clinic_images/' . $img)) {
    $imageSrc2 = '../Clinic/clinic_images/' . $img;
}
else{
    ...
    <br><br>
        <div class="exclusive-discount-pet-container">
            ...
            if ($result->num_rows > 0) {
                ...
                // Check if the image file exists before displaying it
                if (file_exists('../Seller/pet_images/' . $pet_image)) {
                    $imageSrc = '../Seller/pet_images/' . $pet_image;
                }
                ?>
