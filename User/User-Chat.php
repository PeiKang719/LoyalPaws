    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) { 
          ...
          if($row['vetID'] !=NULL){
              ...
              if (file_exists('../Clinic/vet_images/' . $row['vimage'])) {
                  $imageSrc2 = '../Clinic/vet_images/' . $row['vimage'];
              }
              }
              else{
          ...
          if($row['sellerID'] !=NULL){
              ...
              $imageSrc2 = "data:image/jpg;base64," . $imageData;
              // Check if the image file exists before displaying it
              if (file_exists('../Seller/seller_images/' . $row['simage'])) {
                  $imageSrc2 = '../Seller/seller_images/' . $row['simage'];
              }
              }
              else{
