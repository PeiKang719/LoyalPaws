...
if (file_exists('../Clinic/clinic_images/' . $row['clinic_image'])) {
...
elseif (file_exists('../Clinic/clinic_covers/' . $row['cover'])) {
    $imageSrc2 = '../Clinic/clinic_covers/' . $row['cover'];
}
?>
        ...
        <?php function vet(){ 
            ...
            if ($result->num_rows > 0) {
                ...
                if (file_exists('../Clinic/vet_images/' . $row['image'])) {
                    $imageSrc = '../Clinic/vet_images/' . $row['image'];
                }
                }
                else{
                  $gender=$row['ic'][-1];
            ...
            echo '<a href="Clinic-Vet-Profile.php?vid=' . $row['vetID'] . '" target="_self" style="margin:2%"><div class="card2" style="height:275px">';
