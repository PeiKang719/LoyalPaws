...
<section class="s2" style=" padding: 0;width: 100%;background-image: url('../media/section-second.jpg');background-position: 125% 50%;background-size: auto 100%;">
	...
	<div class="section-info" style="margin-left:0;box-shadow: 10px 0 20px -10px black;">
		...
		<div style="display: flex;flex-direction: row;justify-content: center;align-items: center;width: 100%;">
			<a href='../Breed/Dog-Breed.php' class="homepage-section-button" style="width:33%;margin: 0 4%;"><button>Dog Breed</button></a>
			<a href='../Breed/Cat-Breed.php' class="homepage-section-button" style="width:33%;margin: 0 4%;"><button>Cat Breed</button></a>
</div>
</div>
</div>
</section>
