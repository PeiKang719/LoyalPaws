...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        if (file_exists('../Admin/organization_images/' . $row['logo'])) {
            $imageSrc = '../Admin/organization_images/' . $row['logo'];
        }
        ...
        echo '<a href="SideBar_Donation-Organization-Profile.php?id=' . $row['oID'] . '" target="_self"><p>Learn More <span class="material-symbols-outlined" style="vertical-align:-5px">open_in_new</span></p></a>';
        echo '</div>';
        echo '</div>';
    }
} else {
